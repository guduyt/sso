...
/**
 * UsernamePasswordCodeAuthenticationFilter 登录输入验证码校验
 *
 * @author yitao
 * @version 1.0.0
 * @date 2018/6/2 22:48
 */
public class UsernamePasswordCodeAuthenticationFilter extends
        AbstractAuthenticationProcessingFilter {
    public UsernamePasswordCodeAuthenticationFilter(){
        super(new AntPathRequestMatcher("/loginImageCode", "POST"));
    }

    private String usernameParameter = UsernamePasswordAuthenticationFilter.SPRING_SECURITY_FORM_USERNAME_KEY;
    private String passwordParameter = UsernamePasswordAuthenticationFilter.SPRING_SECURITY_FORM_PASSWORD_KEY;
    private final String codeParameter="imageCode";
